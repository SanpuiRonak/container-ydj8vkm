...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ydj8vkm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ydj8vkm.containers.anotherwebservice.com/
...
```
git clone git@github.com:SanpuiRonak/container-ydj8vkm.git
cd container-ydj8vkm
```
...
```
docker attach container-ydj8vkm
```
